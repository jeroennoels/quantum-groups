...
\newenvironment{remarks}{\begin{rems} \rm \begin{enumerate}}{\hfill $\star$
...
% Examples
% --------
\newtheorem{exA}[definition]{Example A}
\newtheorem{exB}[definition]{Example B}
\newtheorem{exC}[definition]{Example C}
\newtheorem{exD}[definition]{Example D}
\newtheorem{exE}[definition]{Example E}
\newtheorem{ex}[definition]{Example}


% default is subsection-wise numbering, exceptional section-wise:
% -------------------------------------------------------------
\newtheorem{prop_sec}{Proposition}[section]
\newtheorem{definition_sec}[prop_sec]{Definition}
\newtheorem{assume_sec}[prop_sec]{Assumptions}
\newtheorem{abs_sec}[prop_sec]{Abstract}
\newtheorem{lemma_sec}[prop_sec]{Lemma}
\newtheorem{thm_sec}[prop_sec]{Theorem}
\newtheorem{cor_sec}[prop_sec]{Corollary}
\newtheorem{summary_sec}[prop_sec]{Summary}
\newtheorem{notation_sec}[prop_sec]{Notation}
\newtheorem{remark_sec}[prop_sec]{Remark}
\newtheorem{rems_sec}[prop_sec]{Remarks}
\newtheorem{setting_sec}[prop_sec]{Setting}



\newtheorem{exA_sec}[prop_sec]{Example A}
\newtheorem{exB_sec}[prop_sec]{Example B}
\newtheorem{exC_sec}[prop_sec]{Example C}
\newtheorem{exD_sec}[prop_sec]{Example D}
\newtheorem{exE_sec}[prop_sec]{Example E}
\newtheorem{ex_sec}[prop_sec]{Example}

\newenvironment{defn_sec}{\begin{definition_sec} \rm}{\hfill $\bullet$
     \end{definition_sec}}
\newenvironment{defn_sec*}{\begin{definition_sec} \rm}{\end{definition_sec}}
\newenvironment{remarks_sec}{\begin{rems_sec} \rm
      \begin{enumerate}}{\hfill $\star$ \end{enumerate} \end{rems_sec}}


\newtheorem{definition_chp}{Definition}[chapter]
\newtheorem{rems_chp}[definition_chp]{Remarks}
\newtheorem{lemma_chp}[definition_chp]{Lemma}
\newtheorem{prop_chp}[definition_chp]{Proposition}
\newtheorem{remark_chp}[definition_chp]{Remark}
\newtheorem{abs_chp_newtheorem}[definition_chp]{Abstract}

\newenvironment{abs_chp}{\small\begin{abs_chp_newtheorem}\rm}{\hfill $\star$ \end{abs_chp_newtheorem}}
\newenvironment{abs_chp*}{\small\begin{abs_chp_newtheorem}\rm}{\end{abs_chp_newtheorem}}


\newenvironment{defn_chp}{\begin{definition_chp} \rm}{\hfill $\bullet$
     \end{definition_chp}}
\newenvironment{remarks_chp}{\begin{rems_chp} \rm
      \begin{enumerate}}{\hfill $\star$  \end{enumerate} \end{rems_chp}}





\newcommand{\newvertS}{\rule{0pt}{0.2ex}}
\newcommand{\newvertM}{\rule{0pt}{2.2ex}}
\newcommand{\newvertL}{\rule{0pt}{2.5ex}}

\newcommand{\down}{$\begin{array}{c}
                        \newvertS \\  \left\downarrow \newvertL \right. \\ \newvertS
                    \end{array}$}
\newcommand{\updown}{$\begin{array}{c}
                        \newvertS \\  \left\updownarrow \newvertL \right. \\ \newvertS
                    \end{array}$}
\newcommand{\lright}{$\!\!\!\longrightarrow\!\!\!$}
\newcommand{\lleft}{$\!\!\!\longleftarrow\!\!\!$}

\newcommand{\boxmargin}{\rule{0.3em}{0pt}}
